...
/*
    ...
    Al polarizarlo en inverso cargaremos dicho "condensador" y este se descargará mas rapido 
    cuanta mas luz reciba la union PN.
    ...
    Si no hubiese indicido ninguna luz, tras unos pocos milisegundos la carga sería el voltaje alque fue sometido.
    Cuanto menor sea el valor leido, mayor podemos asegurar que ha sido la cantidad de luz incidente
